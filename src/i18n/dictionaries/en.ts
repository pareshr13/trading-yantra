...
export const en: Dictionary = {
  ...
  home: {
    ...
    features: [
      ...
      },
      {
        ...
        description: 'Candlestick patterns can hint at where a stock is headed. We spot 12 of them automatically and explain what each one usually means.',
      },
      {
        icon: 'shield',
        title: 'Safety First',
        description: 'When the market looks risky, we tell you to go slow — instead of pushing you to trade no matter what.',
      },
    ],
    ...
    honestyBody: 'Many trading apps promise “guaranteed profits.” We don’t. We test every signal and pattern honestly, and we say so clearly when something doesn’t work as well as people think.',
    honestyPoints: [
      'We test chart patterns properly — and say so honestly when a popular one doesn’t actually help.',
      'We look at the full picture before giving a signal, not just one shape on a chart.',
      'When the market is risky, we say “go slow” — instead of pretending every signal is safe.',
    ],
    statsLabel: 'Our numbers, honestly',
    stats: [
      { value: '12', label: 'Candle patterns' },
      { value: '6', label: 'Market signals' },
  ...
  about: {
    ...
    subcopy: 'In Sanskrit, "yantra" means a precise tool or instrument. We built Trading Yantra to turn confusing stock market data into one simple, honest answer — for everyone, not just finance experts.',
    ...
    howHeading: 'How We Help You Decide',
    ...
    standForCards: [
      { icon: 'shield', title: 'Honesty first', description: 'Every signal is backed by a real check. If something doesn’t work, we say so — clearly, not in fine print.' },
  ...
  product: {
    ...
    subcopy: 'Four tools working together, so you always know what to do next — no finance degree needed.',
    sections: [
      {
        id: 'ai-signals',
        ...
        bullets: [
          ...
          'One more clue, not the final word — it works together with our other signals',
          'Built to add confidence, not replace your own judgement',
        ],
        metricLabel: 'Signal type',
        metricValue: 'AI',
      },
      {
        id: 'indicators',
      ...
      },
      {
        ...
        bullets: [
          ...
          'A safety check can tell you to go slow when the market looks risky',
        ],
    ...
    faqs: [
      ...
      },
      {
        ...
        a: 'A safety check can tell you to go slow or reduce your position size — instead of treating every signal as equally safe no matter what the market is doing.',
      },
      {
        q: 'How do I join?',
